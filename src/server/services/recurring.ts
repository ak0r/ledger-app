import { nextOccurrence, validateRecurringRule, type RecurringFrequency, type RecurringSchedule } from "@/core";
...
export interface RecurringRuleWithNextDue extends RecurringRuleRow {
  // null once the schedule has already ended (docs/completed/2026-08-27-

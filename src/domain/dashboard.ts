...
// keys ship yet. Investment-dependent panels (Recent Investments/Portfolio
// Value/Portfolio NAV) are excluded until valuation exists (spec §11) —
// not represented here even as disabled/placeholder entries (spec: "must
// not be implemented as placeholders").

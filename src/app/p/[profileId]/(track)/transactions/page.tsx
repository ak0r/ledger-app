...
export default async function TransactionsPage(props: PageProps<"/p/[profileId]/transactions">) {
  ...
  if (currencies.length === 0) {
    return (
      <Card>
        ...
        <CardContent>
          <Link href={`/p/${profileId}/accounts`} className={buttonVariants()}>
            Go to Accounts
          </Link>
        </CardContent>
      </Card>
  ...
  const baseHref = `/p/${profileId}/transactions`;

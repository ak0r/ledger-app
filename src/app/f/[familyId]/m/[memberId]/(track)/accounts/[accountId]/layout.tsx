...
export default async function AccountLayout({
  ...
  params: Promise<{ familyId: string; memberId: string; accountId: string }>;
  children: React.ReactNode;
}) {
  const { familyId, memberId, accountId } = await params;
  ...
  const monthlyCashflow = getMonthlyCashflow(db, memberId, accountId);
